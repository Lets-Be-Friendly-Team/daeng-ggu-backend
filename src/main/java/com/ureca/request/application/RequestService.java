    ...
    public List<RequestDto.Response> selectPetProfile(Long customerId) {
        ...
        for(Pet pet : pets) {
            ...
            RequestDto.Response response = RequestDto.Response.builder()
                    ...
                    .isPetRequested(requestRepository.existsByPetAndRequestStatus(pet,"ST1"))
                    .build();
    ...
    public List<RequestDto.Response> selectBeforeRequest(Long customerId) {
        ...
        for(Request request : requests) {
            RequestDto.Response response = RequestDto.Response.builder()
                    ...
                    .majorBreed(commonCodeRepository.findCodeNmByCodeId(request.getPet().getMajorBreedCode()))
                    .desiredServiceCode(request.getDesired_service_code())
                    .isDelivery(request.getIs_delivery())
                    .createdAt(request.getCreatedAt())
                    .codeName(commonCodeRepository.findCodeNmByCodeId(request.getRequest_status()))
                    .build();
            responses.add(response);
        }
        return responses;
